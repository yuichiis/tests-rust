...
void* rindow_load_openblas_func(char *funcname)
{
    if(_h_openblas==NULL) {
    ...
    return GetProcAddress( _h_openblas, funcname );
}
...
)
{
    if(_g_openblas_set_num_threads==NULL) {
        _g_openblas_set_num_threads = rindow_load_openblas_func("openblas_set_num_threads"); 
        if(_g_openblas_set_num_threads==NULL) {
            return;
        }
    }
...
)
{
    if(_g_goto_set_num_threads==NULL) {
        _g_goto_set_num_threads = rindow_load_openblas_func("goto_set_num_threads"); 
        if(_g_goto_set_num_threads==NULL) {
            return;
        }
    }
...
)
{
    if(_g_openblas_get_num_threads==NULL) {
        _g_openblas_get_num_threads = rindow_load_openblas_func("openblas_get_num_threads"); 
        if(_g_openblas_get_num_threads==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_openblas_get_num_procs==NULL) {
        _g_openblas_get_num_procs = rindow_load_openblas_func("openblas_get_num_procs"); 
        if(_g_openblas_get_num_procs==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_openblas_get_config==NULL) {
        _g_openblas_get_config = rindow_load_openblas_func("openblas_get_config"); 
        if(_g_openblas_get_config==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_openblas_get_corename==NULL) {
        _g_openblas_get_corename = rindow_load_openblas_func("openblas_get_corename"); 
        if(_g_openblas_get_corename==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_openblas_get_parallel==NULL) {
        _g_openblas_get_parallel = rindow_load_openblas_func("openblas_get_parallel"); 
        if(_g_openblas_get_parallel==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_sdsdot==NULL) {
        _g_cblas_sdsdot = rindow_load_openblas_func("cblas_sdsdot"); 
        if(_g_cblas_sdsdot==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dsdot==NULL) {
        _g_cblas_dsdot = rindow_load_openblas_func("cblas_dsdot"); 
        if(_g_cblas_dsdot==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_sdot==NULL) {
        _g_cblas_sdot = rindow_load_openblas_func("cblas_sdot"); 
        if(_g_cblas_sdot==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_ddot==NULL) {
        _g_cblas_ddot = rindow_load_openblas_func("cblas_ddot"); 
        if(_g_cblas_ddot==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_cdotu_sub==NULL) {
        _g_cblas_cdotu_sub = rindow_load_openblas_func("cblas_cdotu_sub"); 
        if(_g_cblas_cdotu_sub==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cdotc_sub==NULL) {
        _g_cblas_cdotc_sub = rindow_load_openblas_func("cblas_cdotc_sub"); 
        if(_g_cblas_cdotc_sub==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zdotu_sub==NULL) {
        _g_cblas_zdotu_sub = rindow_load_openblas_func("cblas_zdotu_sub"); 
        if(_g_cblas_zdotu_sub==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zdotc_sub==NULL) {
        _g_cblas_zdotc_sub = rindow_load_openblas_func("cblas_zdotc_sub"); 
        if(_g_cblas_zdotc_sub==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sasum==NULL) {
        _g_cblas_sasum = rindow_load_openblas_func("cblas_sasum"); 
        if(_g_cblas_sasum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dasum==NULL) {
        _g_cblas_dasum = rindow_load_openblas_func("cblas_dasum"); 
        if(_g_cblas_dasum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_scasum==NULL) {
        _g_cblas_scasum = rindow_load_openblas_func("cblas_scasum"); 
        if(_g_cblas_scasum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dzasum==NULL) {
        _g_cblas_dzasum = rindow_load_openblas_func("cblas_dzasum"); 
        if(_g_cblas_dzasum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_ssum==NULL) {
        _g_cblas_ssum = rindow_load_openblas_func("cblas_ssum"); 
        if(_g_cblas_ssum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dsum==NULL) {
        _g_cblas_dsum = rindow_load_openblas_func("cblas_dsum"); 
        if(_g_cblas_dsum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_scsum==NULL) {
        _g_cblas_scsum = rindow_load_openblas_func("cblas_scsum"); 
        if(_g_cblas_scsum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dzsum==NULL) {
        _g_cblas_dzsum = rindow_load_openblas_func("cblas_dzsum"); 
        if(_g_cblas_dzsum==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_snrm2==NULL) {
        _g_cblas_snrm2 = rindow_load_openblas_func("cblas_snrm2"); 
        if(_g_cblas_snrm2==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dnrm2==NULL) {
        _g_cblas_dnrm2 = rindow_load_openblas_func("cblas_dnrm2"); 
        if(_g_cblas_dnrm2==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_scnrm2==NULL) {
        _g_cblas_scnrm2 = rindow_load_openblas_func("cblas_scnrm2"); 
        if(_g_cblas_scnrm2==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_dznrm2==NULL) {
        _g_cblas_dznrm2 = rindow_load_openblas_func("cblas_dznrm2"); 
        if(_g_cblas_dznrm2==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_isamax==NULL) {
        _g_cblas_isamax = rindow_load_openblas_func("cblas_isamax"); 
        if(_g_cblas_isamax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_idamax==NULL) {
        _g_cblas_idamax = rindow_load_openblas_func("cblas_idamax"); 
        if(_g_cblas_idamax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_icamax==NULL) {
        _g_cblas_icamax = rindow_load_openblas_func("cblas_icamax"); 
        if(_g_cblas_icamax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_izamax==NULL) {
        _g_cblas_izamax = rindow_load_openblas_func("cblas_izamax"); 
        if(_g_cblas_izamax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_isamin==NULL) {
        _g_cblas_isamin = rindow_load_openblas_func("cblas_isamin"); 
        if(_g_cblas_isamin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_idamin==NULL) {
        _g_cblas_idamin = rindow_load_openblas_func("cblas_idamin"); 
        if(_g_cblas_idamin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_icamin==NULL) {
        _g_cblas_icamin = rindow_load_openblas_func("cblas_icamin"); 
        if(_g_cblas_icamin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_izamin==NULL) {
        _g_cblas_izamin = rindow_load_openblas_func("cblas_izamin"); 
        if(_g_cblas_izamin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_ismax==NULL) {
        _g_cblas_ismax = rindow_load_openblas_func("cblas_ismax"); 
        if(_g_cblas_ismax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_idmax==NULL) {
        _g_cblas_idmax = rindow_load_openblas_func("cblas_idmax"); 
        if(_g_cblas_idmax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_icmax==NULL) {
        _g_cblas_icmax = rindow_load_openblas_func("cblas_icmax"); 
        if(_g_cblas_icmax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_izmax==NULL) {
        _g_cblas_izmax = rindow_load_openblas_func("cblas_izmax"); 
        if(_g_cblas_izmax==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_ismin==NULL) {
        _g_cblas_ismin = rindow_load_openblas_func("cblas_ismin"); 
        if(_g_cblas_ismin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_idmin==NULL) {
        _g_cblas_idmin = rindow_load_openblas_func("cblas_idmin"); 
        if(_g_cblas_idmin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_icmin==NULL) {
        _g_cblas_icmin = rindow_load_openblas_func("cblas_icmin"); 
        if(_g_cblas_icmin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_izmin==NULL) {
        _g_cblas_izmin = rindow_load_openblas_func("cblas_izmin"); 
        if(_g_cblas_izmin==NULL) {
            return 0;
        }
    }
...
)
{
    if(_g_cblas_saxpy==NULL) {
        _g_cblas_saxpy = rindow_load_openblas_func("cblas_saxpy"); 
        if(_g_cblas_saxpy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_daxpy==NULL) {
        _g_cblas_daxpy = rindow_load_openblas_func("cblas_daxpy"); 
        if(_g_cblas_daxpy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_caxpy==NULL) {
        _g_cblas_caxpy = rindow_load_openblas_func("cblas_caxpy"); 
        if(_g_cblas_caxpy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zaxpy==NULL) {
        _g_cblas_zaxpy = rindow_load_openblas_func("cblas_zaxpy"); 
        if(_g_cblas_zaxpy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_scopy==NULL) {
        _g_cblas_scopy = rindow_load_openblas_func("cblas_scopy"); 
        if(_g_cblas_scopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dcopy==NULL) {
        _g_cblas_dcopy = rindow_load_openblas_func("cblas_dcopy"); 
        if(_g_cblas_dcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ccopy==NULL) {
        _g_cblas_ccopy = rindow_load_openblas_func("cblas_ccopy"); 
        if(_g_cblas_ccopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zcopy==NULL) {
        _g_cblas_zcopy = rindow_load_openblas_func("cblas_zcopy"); 
        if(_g_cblas_zcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sswap==NULL) {
        _g_cblas_sswap = rindow_load_openblas_func("cblas_sswap"); 
        if(_g_cblas_sswap==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dswap==NULL) {
        _g_cblas_dswap = rindow_load_openblas_func("cblas_dswap"); 
        if(_g_cblas_dswap==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cswap==NULL) {
        _g_cblas_cswap = rindow_load_openblas_func("cblas_cswap"); 
        if(_g_cblas_cswap==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zswap==NULL) {
        _g_cblas_zswap = rindow_load_openblas_func("cblas_zswap"); 
        if(_g_cblas_zswap==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_srot==NULL) {
        _g_cblas_srot = rindow_load_openblas_func("cblas_srot"); 
        if(_g_cblas_srot==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_drot==NULL) {
        _g_cblas_drot = rindow_load_openblas_func("cblas_drot"); 
        if(_g_cblas_drot==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_srotg==NULL) {
        _g_cblas_srotg = rindow_load_openblas_func("cblas_srotg"); 
        if(_g_cblas_srotg==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_drotg==NULL) {
        _g_cblas_drotg = rindow_load_openblas_func("cblas_drotg"); 
        if(_g_cblas_drotg==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_srotm==NULL) {
        _g_cblas_srotm = rindow_load_openblas_func("cblas_srotm"); 
        if(_g_cblas_srotm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_drotm==NULL) {
        _g_cblas_drotm = rindow_load_openblas_func("cblas_drotm"); 
        if(_g_cblas_drotm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_srotmg==NULL) {
        _g_cblas_srotmg = rindow_load_openblas_func("cblas_srotmg"); 
        if(_g_cblas_srotmg==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_drotmg==NULL) {
        _g_cblas_drotmg = rindow_load_openblas_func("cblas_drotmg"); 
        if(_g_cblas_drotmg==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sscal==NULL) {
        _g_cblas_sscal = rindow_load_openblas_func("cblas_sscal"); 
        if(_g_cblas_sscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dscal==NULL) {
        _g_cblas_dscal = rindow_load_openblas_func("cblas_dscal"); 
        if(_g_cblas_dscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cscal==NULL) {
        _g_cblas_cscal = rindow_load_openblas_func("cblas_cscal"); 
        if(_g_cblas_cscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zscal==NULL) {
        _g_cblas_zscal = rindow_load_openblas_func("cblas_zscal"); 
        if(_g_cblas_zscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_csscal==NULL) {
        _g_cblas_csscal = rindow_load_openblas_func("cblas_csscal"); 
        if(_g_cblas_csscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zdscal==NULL) {
        _g_cblas_zdscal = rindow_load_openblas_func("cblas_zdscal"); 
        if(_g_cblas_zdscal==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sgemv==NULL) {
        _g_cblas_sgemv = rindow_load_openblas_func("cblas_sgemv"); 
        if(_g_cblas_sgemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dgemv==NULL) {
        _g_cblas_dgemv = rindow_load_openblas_func("cblas_dgemv"); 
        if(_g_cblas_dgemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgemv==NULL) {
        _g_cblas_cgemv = rindow_load_openblas_func("cblas_cgemv"); 
        if(_g_cblas_cgemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgemv==NULL) {
        _g_cblas_zgemv = rindow_load_openblas_func("cblas_zgemv"); 
        if(_g_cblas_zgemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sger==NULL) {
        _g_cblas_sger = rindow_load_openblas_func("cblas_sger"); 
        if(_g_cblas_sger==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dger==NULL) {
        _g_cblas_dger = rindow_load_openblas_func("cblas_dger"); 
        if(_g_cblas_dger==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgeru==NULL) {
        _g_cblas_cgeru = rindow_load_openblas_func("cblas_cgeru"); 
        if(_g_cblas_cgeru==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgerc==NULL) {
        _g_cblas_cgerc = rindow_load_openblas_func("cblas_cgerc"); 
        if(_g_cblas_cgerc==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgeru==NULL) {
        _g_cblas_zgeru = rindow_load_openblas_func("cblas_zgeru"); 
        if(_g_cblas_zgeru==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgerc==NULL) {
        _g_cblas_zgerc = rindow_load_openblas_func("cblas_zgerc"); 
        if(_g_cblas_zgerc==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_strsv==NULL) {
        _g_cblas_strsv = rindow_load_openblas_func("cblas_strsv"); 
        if(_g_cblas_strsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtrsv==NULL) {
        _g_cblas_dtrsv = rindow_load_openblas_func("cblas_dtrsv"); 
        if(_g_cblas_dtrsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctrsv==NULL) {
        _g_cblas_ctrsv = rindow_load_openblas_func("cblas_ctrsv"); 
        if(_g_cblas_ctrsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztrsv==NULL) {
        _g_cblas_ztrsv = rindow_load_openblas_func("cblas_ztrsv"); 
        if(_g_cblas_ztrsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_strmv==NULL) {
        _g_cblas_strmv = rindow_load_openblas_func("cblas_strmv"); 
        if(_g_cblas_strmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtrmv==NULL) {
        _g_cblas_dtrmv = rindow_load_openblas_func("cblas_dtrmv"); 
        if(_g_cblas_dtrmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctrmv==NULL) {
        _g_cblas_ctrmv = rindow_load_openblas_func("cblas_ctrmv"); 
        if(_g_cblas_ctrmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztrmv==NULL) {
        _g_cblas_ztrmv = rindow_load_openblas_func("cblas_ztrmv"); 
        if(_g_cblas_ztrmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssyr==NULL) {
        _g_cblas_ssyr = rindow_load_openblas_func("cblas_ssyr"); 
        if(_g_cblas_ssyr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsyr==NULL) {
        _g_cblas_dsyr = rindow_load_openblas_func("cblas_dsyr"); 
        if(_g_cblas_dsyr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cher==NULL) {
        _g_cblas_cher = rindow_load_openblas_func("cblas_cher"); 
        if(_g_cblas_cher==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zher==NULL) {
        _g_cblas_zher = rindow_load_openblas_func("cblas_zher"); 
        if(_g_cblas_zher==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssyr2==NULL) {
        _g_cblas_ssyr2 = rindow_load_openblas_func("cblas_ssyr2"); 
        if(_g_cblas_ssyr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsyr2==NULL) {
        _g_cblas_dsyr2 = rindow_load_openblas_func("cblas_dsyr2"); 
        if(_g_cblas_dsyr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cher2==NULL) {
        _g_cblas_cher2 = rindow_load_openblas_func("cblas_cher2"); 
        if(_g_cblas_cher2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zher2==NULL) {
        _g_cblas_zher2 = rindow_load_openblas_func("cblas_zher2"); 
        if(_g_cblas_zher2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sgbmv==NULL) {
        _g_cblas_sgbmv = rindow_load_openblas_func("cblas_sgbmv"); 
        if(_g_cblas_sgbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dgbmv==NULL) {
        _g_cblas_dgbmv = rindow_load_openblas_func("cblas_dgbmv"); 
        if(_g_cblas_dgbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgbmv==NULL) {
        _g_cblas_cgbmv = rindow_load_openblas_func("cblas_cgbmv"); 
        if(_g_cblas_cgbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgbmv==NULL) {
        _g_cblas_zgbmv = rindow_load_openblas_func("cblas_zgbmv"); 
        if(_g_cblas_zgbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssbmv==NULL) {
        _g_cblas_ssbmv = rindow_load_openblas_func("cblas_ssbmv"); 
        if(_g_cblas_ssbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsbmv==NULL) {
        _g_cblas_dsbmv = rindow_load_openblas_func("cblas_dsbmv"); 
        if(_g_cblas_dsbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_stbmv==NULL) {
        _g_cblas_stbmv = rindow_load_openblas_func("cblas_stbmv"); 
        if(_g_cblas_stbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtbmv==NULL) {
        _g_cblas_dtbmv = rindow_load_openblas_func("cblas_dtbmv"); 
        if(_g_cblas_dtbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctbmv==NULL) {
        _g_cblas_ctbmv = rindow_load_openblas_func("cblas_ctbmv"); 
        if(_g_cblas_ctbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztbmv==NULL) {
        _g_cblas_ztbmv = rindow_load_openblas_func("cblas_ztbmv"); 
        if(_g_cblas_ztbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_stbsv==NULL) {
        _g_cblas_stbsv = rindow_load_openblas_func("cblas_stbsv"); 
        if(_g_cblas_stbsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtbsv==NULL) {
        _g_cblas_dtbsv = rindow_load_openblas_func("cblas_dtbsv"); 
        if(_g_cblas_dtbsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctbsv==NULL) {
        _g_cblas_ctbsv = rindow_load_openblas_func("cblas_ctbsv"); 
        if(_g_cblas_ctbsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztbsv==NULL) {
        _g_cblas_ztbsv = rindow_load_openblas_func("cblas_ztbsv"); 
        if(_g_cblas_ztbsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_stpmv==NULL) {
        _g_cblas_stpmv = rindow_load_openblas_func("cblas_stpmv"); 
        if(_g_cblas_stpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtpmv==NULL) {
        _g_cblas_dtpmv = rindow_load_openblas_func("cblas_dtpmv"); 
        if(_g_cblas_dtpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctpmv==NULL) {
        _g_cblas_ctpmv = rindow_load_openblas_func("cblas_ctpmv"); 
        if(_g_cblas_ctpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztpmv==NULL) {
        _g_cblas_ztpmv = rindow_load_openblas_func("cblas_ztpmv"); 
        if(_g_cblas_ztpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_stpsv==NULL) {
        _g_cblas_stpsv = rindow_load_openblas_func("cblas_stpsv"); 
        if(_g_cblas_stpsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtpsv==NULL) {
        _g_cblas_dtpsv = rindow_load_openblas_func("cblas_dtpsv"); 
        if(_g_cblas_dtpsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctpsv==NULL) {
        _g_cblas_ctpsv = rindow_load_openblas_func("cblas_ctpsv"); 
        if(_g_cblas_ctpsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztpsv==NULL) {
        _g_cblas_ztpsv = rindow_load_openblas_func("cblas_ztpsv"); 
        if(_g_cblas_ztpsv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssymv==NULL) {
        _g_cblas_ssymv = rindow_load_openblas_func("cblas_ssymv"); 
        if(_g_cblas_ssymv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsymv==NULL) {
        _g_cblas_dsymv = rindow_load_openblas_func("cblas_dsymv"); 
        if(_g_cblas_dsymv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chemv==NULL) {
        _g_cblas_chemv = rindow_load_openblas_func("cblas_chemv"); 
        if(_g_cblas_chemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhemv==NULL) {
        _g_cblas_zhemv = rindow_load_openblas_func("cblas_zhemv"); 
        if(_g_cblas_zhemv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sspmv==NULL) {
        _g_cblas_sspmv = rindow_load_openblas_func("cblas_sspmv"); 
        if(_g_cblas_sspmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dspmv==NULL) {
        _g_cblas_dspmv = rindow_load_openblas_func("cblas_dspmv"); 
        if(_g_cblas_dspmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sspr==NULL) {
        _g_cblas_sspr = rindow_load_openblas_func("cblas_sspr"); 
        if(_g_cblas_sspr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dspr==NULL) {
        _g_cblas_dspr = rindow_load_openblas_func("cblas_dspr"); 
        if(_g_cblas_dspr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chpr==NULL) {
        _g_cblas_chpr = rindow_load_openblas_func("cblas_chpr"); 
        if(_g_cblas_chpr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhpr==NULL) {
        _g_cblas_zhpr = rindow_load_openblas_func("cblas_zhpr"); 
        if(_g_cblas_zhpr==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sspr2==NULL) {
        _g_cblas_sspr2 = rindow_load_openblas_func("cblas_sspr2"); 
        if(_g_cblas_sspr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dspr2==NULL) {
        _g_cblas_dspr2 = rindow_load_openblas_func("cblas_dspr2"); 
        if(_g_cblas_dspr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chpr2==NULL) {
        _g_cblas_chpr2 = rindow_load_openblas_func("cblas_chpr2"); 
        if(_g_cblas_chpr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhpr2==NULL) {
        _g_cblas_zhpr2 = rindow_load_openblas_func("cblas_zhpr2"); 
        if(_g_cblas_zhpr2==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chbmv==NULL) {
        _g_cblas_chbmv = rindow_load_openblas_func("cblas_chbmv"); 
        if(_g_cblas_chbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhbmv==NULL) {
        _g_cblas_zhbmv = rindow_load_openblas_func("cblas_zhbmv"); 
        if(_g_cblas_zhbmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chpmv==NULL) {
        _g_cblas_chpmv = rindow_load_openblas_func("cblas_chpmv"); 
        if(_g_cblas_chpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhpmv==NULL) {
        _g_cblas_zhpmv = rindow_load_openblas_func("cblas_zhpmv"); 
        if(_g_cblas_zhpmv==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sgemm==NULL) {
        _g_cblas_sgemm = rindow_load_openblas_func("cblas_sgemm"); 
        if(_g_cblas_sgemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dgemm==NULL) {
        _g_cblas_dgemm = rindow_load_openblas_func("cblas_dgemm"); 
        if(_g_cblas_dgemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgemm==NULL) {
        _g_cblas_cgemm = rindow_load_openblas_func("cblas_cgemm"); 
        if(_g_cblas_cgemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgemm3m==NULL) {
        _g_cblas_cgemm3m = rindow_load_openblas_func("cblas_cgemm3m"); 
        if(_g_cblas_cgemm3m==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgemm==NULL) {
        _g_cblas_zgemm = rindow_load_openblas_func("cblas_zgemm"); 
        if(_g_cblas_zgemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgemm3m==NULL) {
        _g_cblas_zgemm3m = rindow_load_openblas_func("cblas_zgemm3m"); 
        if(_g_cblas_zgemm3m==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssymm==NULL) {
        _g_cblas_ssymm = rindow_load_openblas_func("cblas_ssymm"); 
        if(_g_cblas_ssymm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsymm==NULL) {
        _g_cblas_dsymm = rindow_load_openblas_func("cblas_dsymm"); 
        if(_g_cblas_dsymm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_csymm==NULL) {
        _g_cblas_csymm = rindow_load_openblas_func("cblas_csymm"); 
        if(_g_cblas_csymm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zsymm==NULL) {
        _g_cblas_zsymm = rindow_load_openblas_func("cblas_zsymm"); 
        if(_g_cblas_zsymm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssyrk==NULL) {
        _g_cblas_ssyrk = rindow_load_openblas_func("cblas_ssyrk"); 
        if(_g_cblas_ssyrk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsyrk==NULL) {
        _g_cblas_dsyrk = rindow_load_openblas_func("cblas_dsyrk"); 
        if(_g_cblas_dsyrk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_csyrk==NULL) {
        _g_cblas_csyrk = rindow_load_openblas_func("cblas_csyrk"); 
        if(_g_cblas_csyrk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zsyrk==NULL) {
        _g_cblas_zsyrk = rindow_load_openblas_func("cblas_zsyrk"); 
        if(_g_cblas_zsyrk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ssyr2k==NULL) {
        _g_cblas_ssyr2k = rindow_load_openblas_func("cblas_ssyr2k"); 
        if(_g_cblas_ssyr2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dsyr2k==NULL) {
        _g_cblas_dsyr2k = rindow_load_openblas_func("cblas_dsyr2k"); 
        if(_g_cblas_dsyr2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_csyr2k==NULL) {
        _g_cblas_csyr2k = rindow_load_openblas_func("cblas_csyr2k"); 
        if(_g_cblas_csyr2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zsyr2k==NULL) {
        _g_cblas_zsyr2k = rindow_load_openblas_func("cblas_zsyr2k"); 
        if(_g_cblas_zsyr2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_strmm==NULL) {
        _g_cblas_strmm = rindow_load_openblas_func("cblas_strmm"); 
        if(_g_cblas_strmm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtrmm==NULL) {
        _g_cblas_dtrmm = rindow_load_openblas_func("cblas_dtrmm"); 
        if(_g_cblas_dtrmm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctrmm==NULL) {
        _g_cblas_ctrmm = rindow_load_openblas_func("cblas_ctrmm"); 
        if(_g_cblas_ctrmm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztrmm==NULL) {
        _g_cblas_ztrmm = rindow_load_openblas_func("cblas_ztrmm"); 
        if(_g_cblas_ztrmm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_strsm==NULL) {
        _g_cblas_strsm = rindow_load_openblas_func("cblas_strsm"); 
        if(_g_cblas_strsm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dtrsm==NULL) {
        _g_cblas_dtrsm = rindow_load_openblas_func("cblas_dtrsm"); 
        if(_g_cblas_dtrsm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ctrsm==NULL) {
        _g_cblas_ctrsm = rindow_load_openblas_func("cblas_ctrsm"); 
        if(_g_cblas_ctrsm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_ztrsm==NULL) {
        _g_cblas_ztrsm = rindow_load_openblas_func("cblas_ztrsm"); 
        if(_g_cblas_ztrsm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_chemm==NULL) {
        _g_cblas_chemm = rindow_load_openblas_func("cblas_chemm"); 
        if(_g_cblas_chemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zhemm==NULL) {
        _g_cblas_zhemm = rindow_load_openblas_func("cblas_zhemm"); 
        if(_g_cblas_zhemm==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cherk==NULL) {
        _g_cblas_cherk = rindow_load_openblas_func("cblas_cherk"); 
        if(_g_cblas_cherk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zherk==NULL) {
        _g_cblas_zherk = rindow_load_openblas_func("cblas_zherk"); 
        if(_g_cblas_zherk==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cher2k==NULL) {
        _g_cblas_cher2k = rindow_load_openblas_func("cblas_cher2k"); 
        if(_g_cblas_cher2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zher2k==NULL) {
        _g_cblas_zher2k = rindow_load_openblas_func("cblas_zher2k"); 
        if(_g_cblas_zher2k==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_saxpby==NULL) {
        _g_cblas_saxpby = rindow_load_openblas_func("cblas_saxpby"); 
        if(_g_cblas_saxpby==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_daxpby==NULL) {
        _g_cblas_daxpby = rindow_load_openblas_func("cblas_daxpby"); 
        if(_g_cblas_daxpby==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_caxpby==NULL) {
        _g_cblas_caxpby = rindow_load_openblas_func("cblas_caxpby"); 
        if(_g_cblas_caxpby==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zaxpby==NULL) {
        _g_cblas_zaxpby = rindow_load_openblas_func("cblas_zaxpby"); 
        if(_g_cblas_zaxpby==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_somatcopy==NULL) {
        _g_cblas_somatcopy = rindow_load_openblas_func("cblas_somatcopy"); 
        if(_g_cblas_somatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_domatcopy==NULL) {
        _g_cblas_domatcopy = rindow_load_openblas_func("cblas_domatcopy"); 
        if(_g_cblas_domatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_comatcopy==NULL) {
        _g_cblas_comatcopy = rindow_load_openblas_func("cblas_comatcopy"); 
        if(_g_cblas_comatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zomatcopy==NULL) {
        _g_cblas_zomatcopy = rindow_load_openblas_func("cblas_zomatcopy"); 
        if(_g_cblas_zomatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_simatcopy==NULL) {
        _g_cblas_simatcopy = rindow_load_openblas_func("cblas_simatcopy"); 
        if(_g_cblas_simatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dimatcopy==NULL) {
        _g_cblas_dimatcopy = rindow_load_openblas_func("cblas_dimatcopy"); 
        if(_g_cblas_dimatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cimatcopy==NULL) {
        _g_cblas_cimatcopy = rindow_load_openblas_func("cblas_cimatcopy"); 
        if(_g_cblas_cimatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zimatcopy==NULL) {
        _g_cblas_zimatcopy = rindow_load_openblas_func("cblas_zimatcopy"); 
        if(_g_cblas_zimatcopy==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_sgeadd==NULL) {
        _g_cblas_sgeadd = rindow_load_openblas_func("cblas_sgeadd"); 
        if(_g_cblas_sgeadd==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_dgeadd==NULL) {
        _g_cblas_dgeadd = rindow_load_openblas_func("cblas_dgeadd"); 
        if(_g_cblas_dgeadd==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_cgeadd==NULL) {
        _g_cblas_cgeadd = rindow_load_openblas_func("cblas_cgeadd"); 
        if(_g_cblas_cgeadd==NULL) {
            return;
        }
    }
...
)
{
    if(_g_cblas_zgeadd==NULL) {
        _g_cblas_zgeadd = rindow_load_openblas_func("cblas_zgeadd"); 
        if(_g_cblas_zgeadd==NULL) {
            return;
        }
    }

...
class OpenBLASClientGenerator
{
    ...
    public function funcTemplate(array $declare) : string
    {
        ...
        $code .= "        _g_{$funcname} = rindow_load_openblas_func(\"$funcname\"); \n";
        $code .= "        if(_g_{$funcname}==NULL) {\n";
        if($return=='void') {
            $code .= "            return;\n";
        } else {
    ...
    function beginTemplate(string $type) : string
    {
        ...
        $code .= "void* rindow_load_openblas_func(char *funcname)\n";
        $code .= "{\n";
        ...
        $code .= "        }\n";
        $code .= "    }\n";
        $code .= "    return GetProcAddress( _h_openblas, funcname );\n";
        $code .= "}\n";
        return $code;
    }
    
    public function endTemplate(array $funcs) : string
    {
        //$code = "void rindow_unload_openblas_dll()\n";
        //$code .= "{\n";
        //foreach($funcs as $declare) {
        //    $funcname = $declare['func'];
        //    $code .= "    _g_{$funcname} = NULL;\n";
        //}
        //$code .= "    if(_h_openblas = NULL) {\n";
        //$code .= "        return;\n";
        //$code .= "    }\n";
